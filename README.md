...
A simple backup helper script driving Synology NAS that copies a Hyper Backup file or folder from a fixed source path to an attached USB-mounted device, then sends an email notification about the result.
